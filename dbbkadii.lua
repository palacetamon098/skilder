...
local Window = Fluent:CreateWindow({
    Title = "đạt béo húp",
    SubTitle = "đạt siêu béo x https://dsc.gg/dakii",
    TabWidth = 160,
...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "6035190846" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "130882646" }),
    Raid = Window:AddTab({ Title = "raid", Icon = "7044284832" }),
    Race = Window:AddTab({ Title = "Race", Icon = "15759170666" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "6031265976" }),
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "auto candy",Description = "max lvl", Default = false })
...
if Second_Sea then
local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
    Title = "auto chest stop when get items",
    Description = "", 
    Default = false })
ToggleChest:OnChanged(function(Value)
    _G.chestsea2 = Value
...
local boss = Tabs.Main:AddSection("Farm Boss")
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "teleport kitsune island",Description = "", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "auto azure",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "auto buy ship",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = " auto Piranha",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " auto fish crew",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "auto ship",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "auto seabeast",Description = "", Default = false })
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://16149561122" then
                    return v
                end
            end
        end
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "auto gear",Description = "", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "auto look moon",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "mirage",Description = "", Default = false })
	...
	spawn(function()
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "auto tushita quest",Description = "", Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "race V2",Description = "",Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "def",Description = "", Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "player cam",Description = "", Default = false })
...
local ToggleFastAttack = Tabs.Player:AddToggle("ToggleFastAttack", {Title = "kill player",Description = "", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "aim Skill",Description = "", Default = false })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "run",Description = "", Default = false })
...
local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title = "auto turn on PVP", Description = "",Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "buy fruits sniper",Description = "", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "auto store fruits",Description = "", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "spin fruits",Description = "", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "auto fruits",Description = "", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "esp fruits",Description = "", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "auto island",Description = "", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "auto race V2",Description = "", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "pick fruits low money",Description = "", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "auto law raid",Description = "", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "auto human and ghoul race",Description = "", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "auto train v4",Description = "", Default = false })
...
local Mastery = Tabs.Shop:AddSection("player")
...
local Mastery = Tabs.Misc:AddSection("show")
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://16149561122"
...
local Mastery = Tabs.Misc:AddSection("full bright")
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("need go to sea 3")
end
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "tele mirage",Description = "", Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "bypass tele",Description = "", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "delete damage",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "delete notifi",Description = "", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "white screen (reduce lag - maybe:)",Description = "", Default = false })
    ...
    elseif _G.WhiteScreen == false then
        ...
        local SKill = Tabs.Setting:AddSection("Mastery")
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "Z skill",Description = "", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "X skill", Description = "",Default = true })
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "C skill",Description = "", Default = true })
...
local ToggleV = Tabs.Setting:AddToggle("ToggleV", {Title = "V skill",Description = "", Default = true })
...
local ToggleF = Tabs.Setting:AddToggle("ToggleF", {Title = "F skill",Description = "", Default = false })
...
local Pos = Tabs.Setting:AddSection("farm positen")
