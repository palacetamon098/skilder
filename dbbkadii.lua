...
--------------------------------------------------------------------------------------------------------------------------------------------
--[[ credit
local Credit = Tabs.Info:AddSection("In Roblox Console (F9 or /console in chat)")
...
spawn(function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow> My discord server : https://dsc.gg/m1m <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Blue> My bio : https://bio.site/m1m <Color=/>"):Display()
end)
--Anti AFK
...
ImageButton.Image = "rbxassetid://16162667221"
...
local listfastattack = {'1','0.15','0 (Risk)','0.5','0.2','0.05'}
    ...
    DropdownDelayAttack:SetValue("0.15")
    DropdownDelayAttack:OnChanged(function(Value)
    _G.FastAttackFaiFao_Mode = Value
	if _G.FastAttackFaiFao_Mode == "0.15" then
		_G.Fast_Delay = 0.15
    elseif _G.FastAttackFaiFao_Mode == "0.5" then
		_G.Fast_Delay = 0.5
	elseif _G.FastAttackFaiFao_Mode == "0.2" then
        _G.Fast_Delay = 0.25
    elseif _G.FastAttackFaiFao_Mode == "0 (risk)" then
		_G.Fast_Delay = 0
    elseif _G.FastAttackFaiFao_Mode == "0.05" then
        _G.Fast_Delay = 0.05
    elseif _G.FastAttackFaiFao_Mode == "1" then
        _G.Fast_Delay = 1
	end
end)
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {Title = "Auto Pirate Raid", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
    Tabs.Main:AddButton({
        Title = "Auto Chest",
        Description = "click to use auto chest script",
        Callback = function()
            _G.Mode = "Marines" -- can change "Marines" or "Pirates"
...
----------------------------------------------------------------------------------------------------------------------------------------------
      Tabs.Main:AddButton({
        ...
        Description = "x2 exp & reset stats",
        Callback = function()
            UseCode()
        end
    })
...
spawn(function()
    ...
    pcall(function()
      ...
      if not string.find(game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == false then
      game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
      if BypassTP then
        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude > 2500 then
        BTP(CFrameQ)
      ...
      elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == true then
      for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    ...
    _G.UseSkill = false
      ...
      until not AutoFarmMasDevilFruit or not v.Parent or v.Humanoid.Health == 0 or game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not TypeMastery == 'Level'
      bringmob = false
      _G.UseSkill = false
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Auto Katakuri", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Auto Kill Boss", Default = false })
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Teleport Kitsune Island", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Embers", Default = false })
...
if Third_Sea then
    local RoughSea = Tabs.Main:AddSection("Sea Event")
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Auto Terrorshark (won't run when low health)", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = "Auto Piranha", Default = false })
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = "Auto Shark", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = "Auto Fish Crew", Default = false })
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Auto Ghost Ship", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race V3", Default = false })
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Auto Sail Boat (W)", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Kill Dough King (need spawn)", Default = false })
...
Camera:Stop()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Enable Bring Mob", Default = true })
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Enable Bypass Tp (auto farm)", Default = false })
...
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    elseif _G.WhiteScreen == false then
        ...
        local SKill = Tabs.Setting:AddSection("Use Skill")
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Demon Fruit", Default = false })
...
Tabs.Player:AddButton({
    Title = "fly gui",
    Description = "can change fly speed",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/palacetamon098/gui/main/diakiai/tset1.lua"))()
...
local ToggleBuy = Tabs.Raid:AddToggle("ToggleBuy", {Title = "Auto Buy Chip", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit Low Money", Default = false })
...
local ToggleAutoT = Tabs.Player:AddToggle("ToggleAutoT", {Title = "Auto Turn On V3 (T)", Description = "Cannot move normally so turns on while auto farming", Default = false })
...
local ToggleAutoY = Tabs.Player:AddToggle("ToggleAutoY", {Title = "Auto Turn On V4 (Y)", Description = "Cannot move normally so turns on while auto farming", Default = false })
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("need go to sea 3 (are you kidding me?)")
end
