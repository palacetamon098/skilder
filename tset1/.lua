...
--------------------------------------------------------------------------------------------------------------------------------------------
local Credit = Tabs.Main:AddSection("In Roblox Console (F9 or /console in chat)")
--[[ credit
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    spawn(function()
        ...
        pcall(function()
          ...
          MonFarm = v.Name
          --Click
          until not _G.AutoLevel or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or game.Players.LocalPlayer.PlayerGui..Quest.Visible == false
          bringmob = false
        end   
          end
          end
       ...
       spawn(function()
           while task.wait() do
               if _G.AutoElite then
                   pcall(function()
                       if game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == true then
                           if string.find(game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text,"Diablo") or string.find(game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text,"Deandre") or string.find(game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text,"Urban") then
...
Tabs.Teleport:AddButton({
    ...
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Travel")
    end
})
    ...
    while wait(.1) do
        pcall(function()
            if _G.Auto_StartRaid then
                if game:GetService("Players")["LocalPlayer"].PlayerGui..Timer.Visible == false then
                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                        if Second_Sea then
                            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button..ClickDetector)
                        elseif Third_Sea then
                            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button..ClickDetector)
                        end
                    end
                end
            end
...
spawn(function()
    while task.wait() do
        if AutoNextIsland then
            pcall(function()
                if game:GetService("Players")["LocalPlayer"].PlayerGui..Timer.Visible == true then
...
local ToggleAutoT = Tabs.Race:AddToggle("ToggleAutoT", {Title = "Auto Turn On V3", Default = false })
...
local ToggleAutoY = Tabs.Race:AddToggle("ToggleAutoY", {Title = "Auto Turn On V4", Default = false })
...
Tabs.Misc:AddButton({
	...
	Callback = function()
		...
		local cac = require(game:GetService("Players").LocalPlayer.PlayerGui..UIController.Inventory)
		...
		while total2 < total do
			...
			while i < 25000 and total2 < total do
				game:GetService("Players").LocalPlayer.PlayerGui.Main.InventoryContainer.Right.Content.ScrollingFrame.CanvasPosition =
					Vector2.new(0, i)
				for k, v in pairs(game:GetService("Players").LocalPlayer.PlayerGui..InventoryContainer.Right.Content.ScrollingFrame.Frame:GetChildren()) do
		...
		local Name = game:GetService("Players").LocalPlayer.PlayerGui..Fragments:Clone()
		Name.Name = "Name"
		Name.Parent = game:GetService("Players").LocalPlayer.PlayerGui..Beli
		Name.Position = UDim2.new(0, 0, -1.5, 0)
		Name.Size = UDim2.new(1, 0, 1, 0)
		Name.TextColor3 = Color3.fromRGB(255, 255, 255)
		Name.Text = game.Players.LocalPlayer.Name
	
		local Fragments = game:GetService("Players").LocalPlayer.PlayerGui..Fragments:Clone()
		Fragments.Name = "FragmentsCheck"
		Fragments.Parent = game:GetService("Players").LocalPlayer.PlayerGui..Beli
...
-- fluent
    ...
    InterfaceManager:SetFolder("Mbm Hub")
     SaveManager:SetFolder("made by minh hub")
